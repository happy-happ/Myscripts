...
class UserInfo {
    ...
    async updateSave() {
        ...
        let url = `https://jd-plusshop-7goyzspef1de45ca-1307535713.ap-shanghai.app.tcloudbase.com/main`
		this.save.items.data['101001003'] = 700 + Math.floor(Math.random()*10000)    //福源
        this.save.level = 30  //等级
        this.save.items.data['101002002'] = 20  + Math.floor(Math.random()*10000)              //道具快速收益
        this.save.items.data['101002001'] = 99                                              //加速道具
